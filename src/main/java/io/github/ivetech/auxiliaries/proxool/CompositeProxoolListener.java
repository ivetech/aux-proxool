...
import io.github.ivetech.auxiliaries.proxool.util.ListenerContainerIF;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import io.github.ivetech.auxiliaries.proxool.util.AbstractListenerContainer;

/**
 * A {@link ProxoolListenerIF} that keeps a list of <code>ProxoolListenerIF</code>s
 * and notifies them in a thread safe manner.
 * It also implements {@link ListenerContainerIF ListenerContainerIF}
 * which provides methods for
 * {@link ListenerContainerIF#addListener(Object) adding} and
 * {@link ListenerContainerIF#removeListener(Object) removing} listeners.
 * 
