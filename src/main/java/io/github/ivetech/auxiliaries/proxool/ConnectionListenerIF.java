 ...
 * ProxoolFacade.{@link ProxoolFacade#addConnectionListener addConnectionListener}(alias, myConnectionListener);
 * </pre>
 *
...
public interface ConnectionListenerIF {
     ...
     * {@link ProxoolConstants#MAXIMUM_ACTIVE_TIME MAXIMUM_ACTIVE_TIME}
     * has been exceeded.
     ...
     * {@link ConnectionValidatorIF#validate(ConnectionPoolDefinitionIF, Connection) validated}.
     * @see #onDeath(Connection, int)
     */
    ...
    /**
     * We are killing a connection because it couldn't be {@link ConnectionResetter#reset(Connection, String) reset}
    ...
    /**
     * We are killing a connection because it's {@link ProxoolConstants#MAXIMUM_CONNECTION_LIFETIME MAXIMUM_CONNECTION_LIFETIME}
     * has been exceeded.
     * @see #onDeath(Connection, int)
     */
    ...
    /**
     * We are killing a connection because a {@link ProxoolConstants#FATAL_SQL_EXCEPTION FATAL_SQL_EXCEPTION}
     * has been detected.
     * @see #onDeath(Connection, int)
     */
