 ...
 */
package io.github.ivetech.auxiliaries.proxool.admin.jndi;

import io.github.ivetech.auxiliaries.proxool.ProxoolDataSource;
...
public class ProxoolJNDIHelper {
    ...
    /**
     * Create a {@link ProxoolDataSource} with the given alias
