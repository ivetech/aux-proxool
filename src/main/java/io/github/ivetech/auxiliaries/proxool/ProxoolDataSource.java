...
import io.github.ivetech.auxiliaries.proxool.admin.StatisticsIF;
...
//             * HH:mm:ss
//             */
//            final DateFormat TIME_FORMAT = new SimpleDateFormat("HH:mm:ss");
//
//            /**
...
//
//                        StringBuilder statisticsHtml = new StringBuilder();
//                        for (StatisticsIF statistics : statisticsArray) {
//                            statisticsHtml.append(printDefinitionEntry(ProxoolConstants.ALIAS, alias, CORE_PROPERTY));
//                            // Period
//                            statisticsHtml.append(printDefinitionEntry("Period", TIME_FORMAT.format(statistics.getStartDate()) + " to " + TIME_FORMAT.format(statistics.getStopDate()), STATISTIC));
//                            // Served
//                            statisticsHtml.append(printDefinitionEntry("Served", statistics.getServedCount() + " (" + DECIMAL_FORMAT.format(statistics.getServedPerSecond()) + "/s)", STATISTIC));
//                            // Refused
//                            statisticsHtml.append(printDefinitionEntry("Refused", statistics.getRefusedCount() + " (" + DECIMAL_FORMAT.format(statistics.getRefusedPerSecond()) + "/s)", STATISTIC));
//                            // averageActiveTime
//                            statisticsHtml.append(printDefinitionEntry("Average active time", DECIMAL_FORMAT.format(statistics.getAverageActiveTime() / 1000) + "s", STATISTIC));
//                        }
//
//                        System.out.println(statisticsHtml.toString());
//
//                    } catch (Exception e) {
//
//                    }
...
//            }
//
//            private String printDefinitionEntry (String name, String value, String type) throws IOException {
//
//                StringBuilder result = new StringBuilder("");
//                result.append("    <tr>");
//                result.append("      <th valign=\"top\">");
//                result.append(name);
//                result.append(":</th>");
//                result.append("      <td class=\"" + type + "\"nowrap>");
