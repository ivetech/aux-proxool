 ...
 * {@link ConnectionPoolDefinitionIF#getStatistics configuration}.
 *
 * <pre>
 * String alias = "myPool";
 * StatisticsListenerIF myStatisticsListener = new MyStatisticsListener();
 * ProxoolFacade.{@link ProxoolFacade#addStatisticsListener addStatisticsListener}(alias, myStatisticsListener);
 * </pre>
