...
import io.github.ivetech.auxiliaries.proxool.admin.Admin;
import io.github.ivetech.auxiliaries.proxool.admin.StatisticsIF;
import io.github.ivetech.auxiliaries.proxool.admin.StatisticsListenerIF;
...
public class ProxoolFacade {
    ...
    private static boolean registerForJmx(String alias, Properties properties) {
        ...
        try {
            Class jmxHelperClass = Class.forName("ProxoolJMXHelper");
    ...
    private static boolean registerDataSource(String alias, Properties jndiProperties) {
        boolean success = false;
        try {
            Class jndiHelperClass = Class.forName("ProxoolJNDIHelper");
